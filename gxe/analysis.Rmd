...
## Stability metrics
A genotype is stable when its performance is unchanged regardless of any variation in the environmental conditions [@hill1998].
...
From the variance components table of the fully random effects model (\ref{randomeffects}), to analyse how much of the phenotypic variability is due to genetic effect, the heritability (calculated based on @atlin2000) and showed a value of `r herit(dropsVarComp)`.
